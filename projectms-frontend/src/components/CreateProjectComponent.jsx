...
class CreateProjectComponent extends Component {
    constructor(props) {
        ...
        this.changeProjectStartDateHandler = this.changeProjectStartDateHandler.bind(this);
        this.changeProjectDueDateHandler = this.changeProjectDueDateHandler.bind(this);
        this.changeProjectCityHandler = this.changeProjectCityHandler.bind(this);
        this.changeProjectStreetHandler = this.changeProjectStreetHandler.bind(this);
        this.changeProjectProvHandler = this.changeProjectProvHandler.bind(this);
        this.changeProjectPostalCodeHandler = this.changeProjectPostalCodeHandler.bind(this);
    ...
    save = (e) => {
        ...
        let project = {projectName: this.state.projectName, projectDesc: this.state.projectDesc, projectStartDate: this.state.projectStartDate, 
            projectDueDate: this.state.projectDueDate, projectCity: this.state.projectCity, projectStreet: this.state.projectStreet, projectProv: this.state.projectProv, projectPostalCode: this.state.projectPostalCode};
                        ...
                        <div className='card col-md-6 offset-md-3 offset-md-3'>
                            ...
                            <form>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input placeholder='Project Description' name='projectDesc' className='form-control'
                                        value={this.state.projectDesc} onChange={this.changeProjectDescHandler} />
                                </div>
                                <div className='form-group'>
                                ...
                                <div className='form-group'>
                                    ...
                                    <input placeholder='Project City' name='projectCity' className='form-control'
                                        value={this.state.projectCity} onChange={this.changeProjectCityHandler} />
                                </div>
                                <div className='form-group'>
                                    <label>Project Street: </label>
                                    <input placeholder='Project Street' name='projectStreety' className='form-control'
                                ...
                                <div className='form-group'>
                                    <label>Project Postal Code: </label>
                                    <input placeholder='Project Postal Code' name='projectPostalCode' className='form-control'
                                        value={this.state.projectPostalCode} onChange={this.changeProjectPostalCodeHandler} />
                                </div>
                                <div className='form-group'>
                                    <label>Client: </label>
                                    <input placeholder='Client' name='Client' className='form-control' />
                                </div>
                                <div className='form-group'>
                                    <label>Status: </label>
...
function WithNavigate(props) {
    ...
    return <CreateProjectComponent {...props} navigate={navigate} match={match} />
}
