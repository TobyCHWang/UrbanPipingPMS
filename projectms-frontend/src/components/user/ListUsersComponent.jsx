                                ...
                                this.state.users.map(
                                    user =>
                                        <tr key={user.userId}>
                                            ...
                                            <td>{user.userRole}</td>
                                            <td>
                                                <button className='btn btn-info' onClick={() => this.editUser(user.userId)}>
                                                    Update
                                                </button>
                                                <button className='btn btn-danger' onClick={() => this.deleteUser(user.userId)}>
                                                    Delete
                                                </button>
                                                <button className='btn btn-info' onClick={() => this.viewUser(user.userId)}>
                                                    View
                                                </button>
                                            </td>
                                        </tr>
